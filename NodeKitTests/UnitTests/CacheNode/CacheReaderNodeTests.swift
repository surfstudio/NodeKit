...
final class CacheReaderNodeTests: XCTestCase {
    ...
    func testThatReadSuccess() {
        ...
        sut.processLegacy(model).onCompleted { data in
            json = data
        }.onError { error in
            XCTFail("\(error)")
        }
    ...
    func testThatDontReadNotOwnRequest() {
    ...
    func testThatNotJsonReturnSerializationError() {
    ...
    func testThatBadJsonReturnSerializationError() {
