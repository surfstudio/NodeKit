Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.exclude_files = 'NodeKit/Encodings/UrlBsonRequestEncodingNode.swift', 'NodeKit/Chains/UrlBsonServiceChainBuilder.swift', 'NodeKit/Chains/UrlBsonChainsBuilder.swift', 'NodeKit/Layers/Bson/*.swift', 'NodeKit/Layers/TransportLayer/Models/TransportUrlBsonRequest.swift', 'NodeKit/Layers/ResponseProcessingLayer/Bson/*.swift', 'NodeKit/Layers/BsonLayerTypes.swift', 'NodeKit/Core/Convertion/Extensions/DTOConvertible+Document.swift', 'NodeKit/Core/Convertion/RawBsonMappable.swift'
  ...
  s.subspec 'BSON' do |sp|
  	...
  	sp.source_files = 'NodeKit/Encodings/UrlBsonRequestEncodingNode.swift', 'NodeKit/Chains/UrlBsonServiceChainBuilder.swift', 'NodeKit/Chains/UrlBsonChainsBuilder.swift', 'NodeKit/Layers/Bson/*.swift', 'NodeKit/Layers/TransportLayer/Models/TransportUrlBsonRequest.swift', 'NodeKit/Layers/ResponseProcessingLayer/Bson/*.swift', 'NodeKit/Layers/BsonLayerTypes.swift', 'NodeKit/Core/Convertion/Extensions/DTOConvertible+Document.swift', 'NodeKit/Core/Convertion/RawBsonMappable.swift'
  end
end
